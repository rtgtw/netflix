  ...
  return (
    ...
    <>
      <div className='relative h-screen text-white '>
        ...
        {/* Get trending movie / get trending tv endpoint from backend */}
        {/* create a custom hook to fetch a movie or a tv show */}
        <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} alt='hero image'
          ...
          <div className='max-w-2xl'>
            ...
            <p className='mt-2 text-lg'>
              ...
              trendingContent?.first_air_date?.split("-")[0]} | {trendingContent?.adult ? "18+" : "PG-13"} | {`Score: ${trendingContent?.popularity}`}
            </p>
